                ...
                <div className='md:w-1/2 w-full px-8 md:px-0 flex flex-col sm:flex-row items-center justify-end relative text-cust-blue gap-5'>
                    ...
                    <div className='relative w-full'>
                        ...
                        <Atropos
                            ...
                            highlight={true}
                            duration={100}
                            className='absolute group md:top-[30%] md:right-[20%] sm:top-[25%] sm:right-[30%]  top-[25%] right-[30%]'

                        >
                            <div data-atropos-offset="15" className='max-w-[130px] sm:max-w-[240px] md:max-w-[150px] lg:max-w-[200px] xl:max-w-[240px] rounded-lg bg-gradient-to-b from-[#CBE0F8] via-[#E2EDF9] to-[#F2F8FF] flex items-center justify-center px-3 sm:px-5 py-2 sm:py-3 text-center border-2 border-gray-300 text-[8px] sm:text-base md:text-sm lg:text-base'>
                        ...
                        <Atropos
                            ...
                            highlight={true}
                            duration={100}
                            className='absolute group md:bottom-[27%] md:left-[7%] sm:left-[0%] left-[10%] bottom-[20%]'
                        ...
                        <Atropos
                            ...
                            highlight={true}
                            duration={100}
                            className='absolute group md:top-[41%] md:left-[-2%] md:bottom-[50%] sm:left-[10%] sm:bottom-[25%] left-[0%] bottom-[40%]'
