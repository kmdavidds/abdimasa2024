        ...
        <section className='font-poppins'>
            <div className="bg-cust-softblue pt-10 lg:px-32 px-10 pb-36">
                ...
                <div className="mb-7">
                    ...
                    <div
                        className={`transition-max-height duration-300 ease-in-out bg-gradient-to-t from-[#F2F8FF] via-[#E2EDF9] to-[#E2EDF9] px-6 py-4 rounded-b-2xl rounded-tr-2xl lg:text-lg text-xs mt-2 border-cust-blue border border-opacity-30`}
                    >
                        {isVisiOpen && (
