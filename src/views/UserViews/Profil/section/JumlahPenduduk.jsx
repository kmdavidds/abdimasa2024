        ...
        <section className='font-poppins' ref={countSectionRef}>
            <div className="bg-cust-softblue pt-24 lg:px-32 px-10 pb-36">
                ...
                <div>
                    ...
                    {error && <div>{error}</div>}
                    {!loading && !error && (
                        <div className='flex flex-col md:flex-row lg:gap-16 gap-7 items-center justify-center'>
                            <div className='gap-7 px-7 py-4 xl:px-16 xl:py-9 flex flex-col w-[60%] md:w-[50%] xl:w-full items-center bg-gradient-to-t from-[#F2F8FF] via-[#E2EDF9] to-[#E2EDF9] border-cust-blue border border-opacity-30 rounded-2xl'>
                                <img src="/images/Profile/JumlahPendudukSection/laki-laki.webp" alt="people" />
                                <div className='flex flex-col items-center'>
                                    <div className="text-cust-blue font-bold text-lg lg:text-3xl">{counts[1]}</div>
                                    <div className="text-cust-gray text-sm lg:text-base xl:text-lg text-center">Jiwa Laki-laki</div>
                                </div>
                            </div>
                            ...
                            <div className='gap-7 px-7 py-4 xl:px-16 xl:py-9 flex flex-col w-[60%] md:w-[50%] xl:w-full items-center bg-gradient-to-t from-[#F2F8FF] via-[#E2EDF9] to-[#E2EDF9] border-cust-blue border border-opacity-30 rounded-2xl'>
                                ...
                                <div className='flex flex-col items-center'>
                                    <div className="text-cust-blue font-bold text-lg lg:text-3xl">{counts[0]}</div>
                                    <div className="text-cust-gray text-sm lg:text-base xl:text-lg text-center">Jiwa Total Penduduk</div>
                                </div>
                            </div>
                            ...
                            <div className='gap-7 px-7 py-4 xl:px-16 xl:py-9 flex flex-col w-[60%] md:w-[50%] xl:w-full items-center bg-gradient-to-t from-[#F2F8FF] via-[#E2EDF9] to-[#E2EDF9] border-cust-blue border border-opacity-30 rounded-2xl'>
                                ...
                                <div className='flex flex-col items-center'>
                                    <div className="text-cust-blue font-bold text-lg lg:text-3xl">{counts[2]}</div>
                                    <div className="text-cust-gray text-sm lg:text-base xl:text-lg text-center">Jiwa Perempuan</div>
                                </div>
                            </div>
                        </div>
                    )}
