        ...
        <section className='font-poppins' ref={countSectionRef}>
            <div className="bg-cust-softblue pt-24 lg:px-32 px-10 pb-36">
                ...
                <div>
                    ...
                    {error && <div>{error}</div>}
                    {!loading && !error && (
                        <div className='grid grid-cols-1 md:grid-cols-3 lg:gap-16 gap-7 '>
                            <div className='gap-7 px-7 py-4 xl:px-16 xl:py-9 flex flex-col items-center bg-gradient-to-t from-[#F2F8FF] via-[#E2EDF9] to-[#E2EDF9] border-cust-blue border border-opacity-30 rounded-2xl'>
                                ...
                                <div className='flex flex-col items-center'>
                                    <div className="text-cust-blue font-bold text-3xl">{counts[1]}</div>
                                    <div className="text-cust-gray text-lg text-center">Jiwa Laki-laki</div>
                                </div>
                            </div>
                            ...
                            <div className='gap-7 px-7 py-4 xl:px-16 xl:py-9 flex flex-col items-center bg-gradient-to-t from-[#F2F8FF] via-[#E2EDF9] to-[#E2EDF9] border-cust-blue border border-opacity-30 rounded-2xl'>
                                ...
                                <div className='flex flex-col items-center'>
                                    <div className="text-cust-blue font-bold text-3xl">{counts[0]}</div>
                                    <div className="text-cust-gray text-lg text-center">Jiwa Total Penduduk</div>
                                </div>
                            </div>
                            ...
                            <div className='gap-7 px-7 py-4 xl:px-16 xl:py-9 flex flex-col items-center bg-gradient-to-t from-[#F2F8FF] via-[#E2EDF9] to-[#E2EDF9] border-cust-blue border border-opacity-30 rounded-2xl'>
                                ...
                                <div className='flex flex-col items-center'>
                                    <div className="text-cust-blue font-bold text-3xl">{counts[2]}</div>
                                    <div className="text-cust-gray text-lg text-center">Jiwa Perempuan</div>
                                </div>
                            </div>
                        </div>
                    )}
