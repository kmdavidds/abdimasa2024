        ...
        return (
            <div className="bg-white relative font-poppins rounded-lg overflow-hidden w-full md:w-1/3 md:max-w-[360px] max-w-[150px] max-h-[175px] md:max-h-[416px]">
                <img
                    ...
                    className="w-full object-cover"
                />
                <div className="p-3 md:p-4 absolute bottom-0 text-white flex justify-between items-end w-full h-full bg-gradient-to-t from-gray-950/90 via-gray-950/20 to-transparent">
                    <div>
