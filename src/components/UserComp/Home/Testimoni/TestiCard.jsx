...
const TestiCard = ({ image, quote, name, occupation }) => {
    return (
        <div className="bg-gradient-to-b text-[#252525] from-[#CBE0F8] via-[#E2EDF9] to-[#F2F8FF]  rounded-xl shadow-xl w-1/2 sm:w-full max-w-[180px] sm:max-w-[280px] lg:w-1/3 lg:max-w-[360px] px-3 sm:px-6 py-4 sm:py-8 space-y-3 sm:space-y-8 flex flex-col justify-between">
