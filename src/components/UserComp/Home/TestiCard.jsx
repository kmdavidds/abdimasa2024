...
const TestiCard = ({ image, quote, name, occupation }) => {
    return (
        <div className="bg-gradient-to-b text-[#252525] from-[#CBE0F8] via-[#E2EDF9] to-[#F2F8FF]  rounded-xl shadow-xl max-w-[360px] px-6 py-8 space-y-8 flex flex-col justify-between">
